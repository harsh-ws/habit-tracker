...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.finishedDays.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.finishedDays);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.finishedDays = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'finishedDays',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      finishedDaysElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'finishedDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'finishedDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> finishedDaysLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByFinishedDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'finishedDays');
    });
  }
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<DateTime>, QQueryOperations> finishedDaysProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'finishedDays');
    });
  }
